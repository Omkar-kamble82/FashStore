        ...
        <div>
            <div className="px-3 py-10 flex items-center justify-center gap-5 flex-wrap">
                {Categoriesdata.map((data) => {
                    return(
                        <a href={`#${data.heading}`} className="min-w-[240px] w-[360px] lg:w-[340px] border-2 min-h-[360px] flex justify-between relative items-center cursor-pointer transition-all duration-500" key={data.id}>
